...
I can't use `seq(...)` because the distance between 2 observations in this vector is not fixed.
...
The resulting class is character because that class is to the right of the numeric class.