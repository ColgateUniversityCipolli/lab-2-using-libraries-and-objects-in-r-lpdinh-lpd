...
Adelie penguins seem to be largest in quantity. Adelie and Chinstrap penguins, on average, have lower body mass than Gentoo penguines. 
...
(txrepeated <- rep(c("Control", "Treatment A", "Treatment B"), each=10))
```
